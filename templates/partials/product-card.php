<?php
$candidateHeadingTag = $headingTag ?? 'h2';
$headingTag = in_array($candidateHeadingTag, ['h2', 'h3'], true) ? $candidateHeadingTag : 'h2';
?>
<article class="product-card">
  ...
  <div class="product-card__body">
    ...
    <<?= $headingTag ?> class="product-card__title"><a href="/product/<?= e($product['slug']) ?>/"><?= e($product['name']) ?> <span><?= e($product['subtitle']) ?></span></a></<?= $headingTag ?>>
